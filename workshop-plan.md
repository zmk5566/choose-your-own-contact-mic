...
做一只接触式麦克风，然后用它听。一个下午。

### 工作坊理念

"There is no such thing as silence." 这是出发点，不是结论。

我们日常听到的声音，几乎都是空气中的振动。物体内部也在振动，只是大部分时候不被空气传到我们耳朵。**接触式麦克风（Contact Microphone）** 是一种贴在物体表面、直接拾取固体振动的传感器。

工作坊提供材料、电路、和三条参考路径。每个人做的麦克风、录的声音、想分享的内容，都是自己的。"自由选择"不是放任——是给出三条清晰的路径，让你按自己的节奏和兴趣走下去。

最后我们一起在一个安静的房间里，听每个人录的 60 秒。
...
Build a contact microphone. Use it. One afternoon.

### Workshop Philosophy

"There is no such thing as silence." A starting point, not a conclusion.
...
We provide the materials, the circuits, and three reference paths. The microphone you end up with, the sounds you record, and what you choose to share — those belong to you. "Free choice" isn't anything-goes; it's three clear paths you can take at your own pace.

At the end, we sit together in a quiet room and listen to 60 seconds from each person.
